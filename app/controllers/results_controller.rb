class ResultsController <ApplicationController
  ...
  def index
    ...
    @ethnicity_graduates_of_program = School.find_queried_graduates_count(params[:college], params[:program], params[:ethnicity], params[:year])
    
    @all_graduates = School.find_all_graduates_of_program(params[:college], params[:program], params[:year])
